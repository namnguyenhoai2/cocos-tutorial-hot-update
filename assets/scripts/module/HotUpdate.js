...
var customManifestStr = JSON.stringify({
    "packageUrl": "http://127.0.0.1:55012/remote-assets/",
    "remoteManifestUrl": "http://127.0.0.1:55012/remote-assets/project.manifest",
    "remoteVersionUrl": "http://127.0.0.1:55012/remote-assets/version.manifest",
    "version": "1.10",
    "assets": {
...
cc.Class({
    ...
    onLoad: function () {
        ...
        this._storagePath = ((jsb.fileUtils ? jsb.fileUtils.getWritablePath() + '/test_hot/' : '/test_hot/') + 'blackjack-remote-asset');
